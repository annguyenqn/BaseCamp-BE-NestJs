...
describe('CompanyController', () => {
      ...
      users: [
        {
          ...
          passwordHash:
            '$1b$10$vUDz16tsb3OsskHrBSCY7uAYysI44gdUnKnDkNvHrlDrTr7GXU.km',
          firstName: 'demo test',
          lastName: 'User',
          status: 'active',
          companyId: 1,
        },
        {
          ...
          passwordHash:
            '$1b$10$4GL7l1fkOW4AH311PrIGiu1tyRVfgsxA03NoEc1UG1ABK7pNMeSTK',
          firstName: 'Regular',
          lastName: 'User',
          status: 'active',
          companyId: 1,
        },
        {
          ...
          passwordHash:
            '$1b$10$Y3IRHl79Fc6ApP06WhVwgeKWd1p1T1hRMQmcy3Og179n5yQ8/oSy6',
          firstName: 'Regular',
          lastName: 'User',
          status: 'active',
          companyId: 1,
  ...
  it('should throw NotFoundException when user is not found', async () => {
    ...
    mockCompanyService.findCompanyById.mockRejectedValue(
  ...
  it('should remove the user when user is found', async () => {
    ...
    await expect(
      mockCompanyService.removeCompany(companyId),
